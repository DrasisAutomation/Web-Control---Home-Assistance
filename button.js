  ...
  function setupModalListeners() {
    ...
    document.querySelectorAll(".button-type-item").forEach((item) => {
      item.addEventListener("click", (e) => {
        ...
        // For remote buttons, use RemoteModule which handles its own prompts
        if (type === "remote" && window.RemoteModule && typeof window.RemoteModule.create === "function") {
          ...
          if (entityId && entityId.trim()) {
            ...
            } else if (type === "curtain" && window.CurtainModule && typeof window.CurtainModule.create === "function") {
