...
window.SVGIcons = (function() {
    ...
    function initialize() {
        ...
        const commonIcons = [
            'light-bulb-1.svg', 'light-bulb-2.svg', 'ceiling-light.svg',
            'table-light-1.svg', 'table-light-2.svg', 'chandelier-1.svg',
            'chandelier-2.svg', 'chandelier-3.svg', 'dimmer.svg',
            'dimmer-1.svg', 'dimmer-3.svg', 'fan.svg',
            'ac-1.svg', 'ac-2.svg', 'ac-3.svg',
            'climate.svg', 'door-opened.svg', 'door-closed.svg',
            'lock.svg', 'lock-open.svg', 'alarm.svg',
            'person-fall-1.svg', 'person-fall-2.svg', 'walk-1.svg'
        ];
